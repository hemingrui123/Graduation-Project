...
//import com.kmxy.es.EsBlogDo;
//import com.kmxy.es.EsBlogRepository;
import com.kmxy.mapper.BlogExtendMapper;
import com.kmxy.mapper.BlogMapper;
import com.kmxy.mapper.BlogTagExtendMapper;
...
import com.kmxy.util.MarkdownUtils;
...
public class BlogServiceImpl implements BlogService {
     ...
     * @param pageSize    3
     * @param userId      4
     * @return com.github.pagehelper.PageInfo<com.kmxy.vo.BlogVo>
     **/
    @Override
    public PageInfo<BlogVo> page(BlogExample blogExample, Integer pageNum,
        ...
        for (BlogVo blogVo : list) {
            ...
            if (redisValueUtil.hExists(RedisConstant.COMMENT_KEY,
                ...
                log.info("执行到更新博客编号[{}]的评论数为redis最新评论数据：{}", blogVo.getBlogId(),
                        blogComments);
            }
     ...
     *
     * @param userId 1
     * @return java.util.Map<java.lang.String                                                                                                                                                                                                                                                               ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               java.util.List                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               <                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               com.kmxy.entity.Blog>>
     * 
